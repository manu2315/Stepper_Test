 ...
 */
public class Test2Fragment extends Fragment implements Step,StepperLayout.StepperListener {
    ...
    public void onSelected() {
        Toast.makeText(getContext(), "onSelected 2", Toast.LENGTH_SHORT).show();
    }
